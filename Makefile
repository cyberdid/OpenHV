...
test-simulation:
	...
	@python3 generate-baseline-manifest.py \
		...
		--check
	@python3 generate-baseline-manifest.py \
		--variant ai003-candidate-v2 \
		--output batch-manifests/ai003-candidate-112-v2.json \
		--check
	@python3 generate-baseline-manifest.py \
		--variant ai003-candidate-v3 \
		--output batch-manifests/ai003-candidate-112-v3.json \
		--check
	@python3 generate-baseline-manifest.py \
	...
	@python3 generate-baseline-manifest.py \
		...
		--check
	@python3 generate-baseline-manifest.py \
		--variant econ001-candidate \
		--output batch-manifests/econ001-candidate-112-v1.json \
		--check
	@python3 generate-baseline-manifest.py \
		--variant econ002-candidate \
		--output batch-manifests/econ002-candidate-112-v1.json \
		--check
	@python3 generate-baseline-manifest.py \
		--variant dip001-candidate \
		--output batch-manifests/dip001-candidate-112-v1.json \
		--check
	@python3 generate-baseline-manifest.py \
		--variant baseline-v3 \
		--output batch-manifests/baseline-112-v3.json \
		--check
	@python3 generate-baseline-manifest.py \
		--variant dip002-candidate \
		--output batch-manifests/dip002-candidate-112-v1.json \
		--check
	@python3 generate-baseline-manifest.py \
	...
	@python3 generate-baseline-manifest.py \
		...
		--check
	@python3 generate-baseline-manifest.py \
		--variant baseline-long \
		--output batch-manifests/baseline-long-112-v1.json \
		--check
