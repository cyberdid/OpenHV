...
SIMULATION_SCENARIO_MODE="${SIMULATION_SCENARIO_MODE:-living-world}"
SIMULATION_OBSERVATION_HORIZON_TICKS="${SIMULATION_OBSERVATION_HORIZON_TICKS:-}"
...
SIMULATION_WATCHDOG_SECONDS="${SIMULATION_WATCHDOG_SECONDS:-0}"
...
SIMULATION_CHECKPOINT_WORLD_TICK="${SIMULATION_CHECKPOINT_WORLD_TICK:-0}"
SIMULATION_CHECKPOINT_NAME="${SIMULATION_CHECKPOINT_NAME:-}"
SIMULATION_LOAD_CHECKPOINT="${SIMULATION_LOAD_CHECKPOINT:-}"
...
exec "${PROJECT_DIR}/launch-game.sh" \
	...
	"Launch.SimulationCheckpointWorldTick=${SIMULATION_CHECKPOINT_WORLD_TICK}" \
	"Launch.SimulationCheckpointName=${SIMULATION_CHECKPOINT_NAME}" \
	"Launch.SimulationLoadCheckpoint=${SIMULATION_LOAD_CHECKPOINT}"
