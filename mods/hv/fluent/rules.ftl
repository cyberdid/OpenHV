...
actor-swarmbase =
   .name = Hive Core
   .description = Grows the colony and anchors its territory.
actor-swarmgen =
   .name = Bio-Reactor
   .description = Metabolises energy for the colony.
actor-swarmstore =
   .name = Digestion Pit
   .description = Breaks down harvested matter.
actor-swarmpod =
   .name = Spawning Nursery
   .description = Breeds small organisms.
actor-swarmforge =
   .name = Grafting Forge
   .description = Assembles the larger organisms.
actor-swarmharvester =
   .name = Grazer
   .description = Feeds on ore and carries it back.
actor-swarmcarrier =
   .name = Seed Carrier
   .description = Splits open into a new hive core.
actor-swarmwarrior =
   .name = Warrior
   .description = Bone blades. Closes to melee.
actor-swarmspitter =
   .name = Spitter
   .description = Pressurised gland. Fires at range.
actor-swarmrunner =
   .name = Runner
   .description = Fast and fragile. Finds the enemy.
actor-swarmbruiser =
   .name = Bruiser
   .description = Armoured ram. Breaks defences.
actor-swarmmortar =
   .name = Spore Mortar
   .description = Lobs spores over distance.
actor-swarmlance =
   .name = Sky Lance
   .description = Launches barbed spines at aircraft.
actor-swarmburrower =
   .name = Burrower
   .description = Ambushes from below.
actor-swarmdrifter =
   .name = Drifter
   .description = Drops acid sacs on ground targets.
actor-swarminterceptor =
   .name = Interceptor
   .description = Hunts other fliers.
actor-swarmharvester2 =
   .name = Anchored Grazer
   .description = A grazer locked to the ground, drawing ore.
