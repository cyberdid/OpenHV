...
clear-map-generator-option-tile = Tile
clear-map-generator-choice-tile-crater =
   .label = Crater
clear-map-generator-choice-tile-littoral =
   .label = Littoral
clear-map-generator-choice-tile-grass =
   .label = Grass
clear-map-generator-choice-tile-grass-pit =
   .label = Grass Pit
clear-map-generator-choice-tile-mountain =
   .label = Mountain
clear-map-generator-choice-tile-ice =
   .label = Ice
clear-map-generator-choice-tile-lava =
   .label = Lava
clear-map-generator-choice-tile-sand =
   .label = Sand
clear-map-generator-choice-tile-red-snow =
   .label = Red Snow
clear-map-generator-choice-tile-snow =
   .label = Snow
clear-map-generator-choice-tile-stone =
   .label = Stone
clear-map-generator-choice-tile-swamp =
   .label = Swamp
clear-map-generator-choice-tile-tech =
   .label = Tech
clear-map-generator-choice-tile-pelagic =
   .label = Pelagic
clear-map-generator-choice-tile-tree-grass =
   .label = Tree Gras
clear-map-generator-choice-tile-tree-snow =
   .label = Tree Snow
clear-map-generator-choice-tile-dirt =
   .label = Dirt
...
faction-swarm =
   .name = Hive Swarm
   .description = A grown faction. Its structures are organisms and its units are bred, not built.
actor-swarmbase =
   .name = Hive Core
   .description = Hive Core of the Hive Swarm.
actor-swarmoutpost =
   .name = Hive Seed
   .description = Hive Seed of the Hive Swarm.
actor-swarmgen =
   .name = Bio-Reactor
   .description = Bio-Reactor of the Hive Swarm.
actor-swarmstore =
   .name = Digestion Pit
   .description = Digestion Pit of the Hive Swarm.
actor-swarmpod =
   .name = Spawning Nursery
   .description = Spawning Nursery of the Hive Swarm.
actor-swarmforge =
   .name = Grafting Forge
   .description = Grafting Forge of the Hive Swarm.
actor-swarmradar =
   .name = Sensory Node
   .description = Sensory Node of the Hive Swarm.
actor-swarmstarport =
   .name = Launch Cyst
   .description = Launch Cyst of the Hive Swarm.
actor-swarmtech =
   .name = Gene Vault
   .description = Gene Vault of the Hive Swarm.
actor-swarmtrader =
   .name = Exchange Gland
   .description = Exchange Gland of the Hive Swarm.
actor-swarmharbor =
   .name = Tidal Spawn
   .description = Tidal Spawn of the Hive Swarm.
actor-swarmbunker =
   .name = Carapace Nest
   .description = Carapace Nest of the Hive Swarm.
actor-swarmturret =
   .name = Barb Tower
   .description = Barb Tower of the Hive Swarm.
actor-swarmaaturret =
   .name = Spine Tower
   .description = Spine Tower of the Hive Swarm.
actor-swarmfield =
   .name = Spore Field
   .description = Spore Field of the Hive Swarm.
actor-swarmuplink =
   .name = Deep Choir
   .description = Deep Choir of the Hive Swarm.
actor-swarmtelevator =
   .name = Burrow Gate
   .description = Burrow Gate of the Hive Swarm.
actor-swarmbarrier =
   .name = Chitin Wall
   .description = Chitin Wall of the Hive Swarm.
actor-swarmminer2 =
   .name = Anchored Grazer
   .description = Anchored Grazer of the Hive Swarm.
actor-swarmwarrior =
   .name = Warrior
   .description = Warrior of the Hive Swarm.
actor-swarmspitter =
   .name = Spitter
   .description = Spitter of the Hive Swarm.
actor-swarmrunner =
   .name = Runner
   .description = Runner of the Hive Swarm.
actor-swarmtender =
   .name = Tender
   .description = Tender of the Hive Swarm.
actor-swarmbroker =
   .name = Envoy
   .description = Envoy of the Hive Swarm.
actor-swarmflyer =
   .name = Leaper
   .description = Leaper of the Hive Swarm.
actor-swarmblaster =
   .name = Bursar
   .description = Bursar of the Hive Swarm.
actor-swarmbruiser =
   .name = Bruiser
   .description = Bruiser of the Hive Swarm.
actor-swarmskitter =
   .name = Skitter
   .description = Skitter of the Hive Swarm.
actor-swarmporter =
   .name = Porter
   .description = Porter of the Hive Swarm.
actor-swarmmortar =
   .name = Spore Mortar
   .description = Spore Mortar of the Hive Swarm.
actor-swarmlance =
   .name = Sky Lance
   .description = Sky Lance of the Hive Swarm.
actor-swarmburrower =
   .name = Burrower
   .description = Burrower of the Hive Swarm.
actor-swarmshocktank =
   .name = Arc Beast
   .description = Arc Beast of the Hive Swarm.
actor-swarmjammer =
   .name = Static Maw
   .description = Static Maw of the Hive Swarm.
actor-swarmeye =
   .name = Watcher
   .description = Watcher of the Hive Swarm.
actor-swarmmender =
   .name = Mender
   .description = Mender of the Hive Swarm.
actor-swarmseeder =
   .name = Seeder
   .description = Seeder of the Hive Swarm.
actor-swarmcarrier =
   .name = Seed Carrier
   .description = Seed Carrier of the Hive Swarm.
actor-swarmharvester =
   .name = Grazer
   .description = Grazer of the Hive Swarm.
actor-swarmcvit =
   .name = Scavenger
   .description = Scavenger of the Hive Swarm.
actor-swarmdrifter =
   .name = Drifter
   .description = Drifter of the Hive Swarm.
actor-swarminterceptor =
   .name = Interceptor
   .description = Interceptor of the Hive Swarm.
actor-swarmspore =
   .name = Drift Sac
   .description = Drift Sac of the Hive Swarm.
actor-swarmferry =
   .name = Ferry
   .description = Ferry of the Hive Swarm.
actor-swarmleviathan =
   .name = Leviathan
   .description = Leviathan of the Hive Swarm.
actor-swarmsmelt =
   .name = Rendering Gut
   .description = Rendering Gut of the Hive Swarm.
actor-swarmhowitzer =
   .name = Bile Cannon
   .description = Bile Cannon of the Hive Swarm.
actor-swarmsilo =
   .name = Brood Silo
