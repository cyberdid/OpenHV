...
| SAV-01 | Persistent save/load across geological-to-space history | Universe save schema + replay checkpoints | save/reload hash equality | native foundation: schema 7 restores evolving elevation/material, physics, climate, near-surface/eight-level atmosphere, all water reservoirs, precipitation, and all ledgers with full branch parity; every future domain trait must join the contract |
